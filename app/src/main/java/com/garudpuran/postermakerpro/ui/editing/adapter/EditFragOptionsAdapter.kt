...
class EditFragOptionsAdapter(val context: Context, private val mListener: EditOptionsListener) :
    ...
    private val dataset = listOf<EditFragOptionsModel>(
        ...
        EditFragOptionsModel(5, "Contacts"),
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        if (position == selectedPosition) {
            ...
            holder.titleView.setTextColor(context.getColor(com.denzcoskun.imageslider.R.color.grey_font))
        }
