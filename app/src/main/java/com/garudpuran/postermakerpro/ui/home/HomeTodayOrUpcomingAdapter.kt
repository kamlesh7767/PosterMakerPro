...
class HomeTodayOrUpcomingAdapter(private val mListener:HomeTodayOrUpcomingAdapterListener):RecyclerView.Adapter<HomeTodayOrUpcomingAdapter.ItemViewHolder>() {
