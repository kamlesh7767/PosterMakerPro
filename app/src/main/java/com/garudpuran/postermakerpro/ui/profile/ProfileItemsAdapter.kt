...
class ProfileItemsAdapter(private val mListener:ProfileItemsAdapterListener):RecyclerView.Adapter<ProfileItemsAdapter.ItemViewHolder>() {
...
mListener.onProfileDeleteBtnClicked(item)
        }
    }
    ...
    interface ProfileItemsAdapterListener{
        fun onProfileDeleteBtnClicked(item :UserProfessionalProfileModel)
    }
}